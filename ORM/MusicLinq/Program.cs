...
namespace ConsoleApplication {
    public class Program {
        public static void Main (string[] args) {
            ...
            var myArtist = Artists.Where (a => a.Hometown == "Mount Vernon")
                .Select (artist => new { artist.ArtistName, artist.Age });
            ...
            var notNYC = Artists.Where(a => a.Hometown != "New York City"); 
            foreach (var artist in notNYC)
            {
                Console.WriteLine(artist.RealName + " is " + artist.Age + " years old and is from " + artist.Hometown);
            }
